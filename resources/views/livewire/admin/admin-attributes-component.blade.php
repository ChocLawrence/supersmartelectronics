                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <a href="#" onclick="confirm('Are you sure you want to delete this attribute?') || event.stopImmediatePropagation()" wire:click.prevent="deleteAttribute({{$pattribute->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                  </td>
                              </tr>
