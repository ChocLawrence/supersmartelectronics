        ...
        <div class=" main-content-area">
            @if(Cart::instance('cart')->count()>0)
                        ...
                        <ul class="products-cart">
                            @foreach(Cart::instance('cart')->content() as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="delete">
                                        <a href="#" class="btn btn-delete" title="Remove item from cart"  wire:click.prevent="destroy('{{$item->rowId}}')">
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        <p class="summary-info total-info "><span class="title">Sub total with Discount</span><b class="index">${{number_format($subtotalAfterDiscount,2)}}</b></p>
            ...
            @else 
                <div class="text-center" style="padding: 30px 0;">
                   ...
                   <a href="{{route('product.shop')}}" class="btn btn-success">Shop Now</a>
                </div>    
            @endif
                    ...
                    <ul class="products-cart">
                        @foreach(Cart::instance('saveForLater')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="delete">
                                    <a href="#" class="btn btn-delete" title="Remove item from cart"  wire:click.prevent="deleteFromSaveForLater('{{$item->rowId}}')">
