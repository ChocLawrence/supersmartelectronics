...
<head>
	...
	<title>Home | Super Smart Electronics</title>	
	...
	content="Looking for all latest electronics. Phones, laptops and all smart electronics. Here is home to a diverse amount of products for your needs.">

	<!---Meta keywords--->
	
	<meta name="keywords" content="iphones,phones,laptops ,smart phones, electronics, new phones" />
...
<body class="home-page home-01 ">
										...
										@else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="Orders" href="{{ route('user.profile') }}">Profile</a>
													</li>	
													<li class="menu-item" >
					...
					<div class="header-nav-section">
						<div class="container">
							<ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info" >
								<li class="menu-item"><a href="#" class="link-term">Weekly Updates</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Hot Sales</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Always New</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Top Notch</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Money back guarantee</a><span class="nav-label hot-label">hot</span></li>
							</ul>
						</div>
					</div>
	...
	{{-- <script src="https://cdn.tiny.cloud/1/3l6wmz8ciu834ctz3cc9raor5vvei9zbmkcgza0ts75zmvgt/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script> --}}
